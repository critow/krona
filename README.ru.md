...
| `lineHeight` | `number` | `20` | Высота строки в пикселях. Именно фиксированная высота делает виртуализацию точной |
...
| `defaultCollapsedDepth` | `number` | — | Свернуть при загрузке все диапазоны этой глубины и глубже; `0` сворачивает всё |
